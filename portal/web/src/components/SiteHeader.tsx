...
const navItem = "relative z-10 grid min-h-[58px] min-w-[176px] place-items-center bg-[url('/media/game-ui/jade/button-default.png')] bg-[length:100%_100%] bg-center bg-no-repeat px-8 font-miraj-of-icarus text-[.78rem] font-semibold uppercase tracking-[.08em] text-[#e0e9df] [text-shadow:0_2px_2px_#041b16] focus-visible:bg-[url('/media/game-ui/jade/button-focused.png')] focus-visible:text-white focus-visible:drop-shadow-[0_0_7px_rgba(40,185,111,.7)] max-[1050px]:min-w-[150px] max-[900px]:min-w-[126px] max-[900px]:px-5 max-[700px]:min-w-[118px] max-[700px]:px-3";

const accountItem = "grid min-h-9 min-w-[116px] place-items-center bg-[url('/media/game-ui/jade/button-default.png')] bg-[length:100%_100%] bg-center bg-no-repeat px-5 focus-visible:bg-[url('/media/game-ui/jade/button-focused.png')] focus-visible:text-white";
